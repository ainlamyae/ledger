...
- **Summary cards** — at-a-glance Total Savings, monthly income, monthly expenses, Net Cash Flow, and reconciliation status (✅, or the discrepancy amount if account balances don't match transaction history).
