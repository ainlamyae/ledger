...
- Rows are added three ways: manually, via the breakdown's ＋ Save button, or auto-banked by Recalculate Selected — a fresh row this way only ever carries Classification (blank) through Protein; Fiber/Fat/Carbohydrate/TEF/Verification/Percent/Micronutrients are left for you (or 🧬 Pull Micronutrients) to fill in.
