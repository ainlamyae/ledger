...
- **Common** — a panel of three bar charts derived straight from transaction history (income rows excluded): **Most Common Expense Descriptions** and **Most Common Payees** (record counts, top 36), and **Total Spend by Payee** (summed expense amounts, top 36 by absolute total, bars colored green/red for net income/expense).
